...
import { SafeAreaView, StyleSheet, TextInput,Image, TouchableOpacity, Dimensions, ScrollView, Text, View, Button } from "react-native";
    ...
    <SafeAreaView>
      ...
      <ScrollView showsVerticalScrollIndicator={false} >
        <View style={styles.container}>
          ...
          <View style={{ flexDirection: "row", justifyContent: 'center',marginTop:240 }}>
            <View style={{ marginRight: 12, borderWidth: 1, borderRadius: 80 }}>
              <Image
